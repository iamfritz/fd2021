...
function customozer_social_media_url( $wp_customize ) {
	...
	$wp_customize->add_setting(
		BASIC_OPTION_NAME . '[smu_facebook]',
		array(
			'type'              => 'option',
			'default'           => '',
			'sanitize_callback' => 'basic_sanitize_text',
	...
	$wp_customize->add_control( 'smu_facebook_control',
		array(
			'settings' => BASIC_OPTION_NAME . '[smu_facebook]',
			'label'    => 'Facebook URL',
	...
	$wp_customize->add_control( 'smu_twitter_control',
		array(
			'settings' => BASIC_OPTION_NAME . '[smu_twitter]',
			'label'    => 'Twitter URL',
			'section'  => 'social_media_url',
			'type'     => 'text',
		)
	...
	$wp_customize->add_setting(
		BASIC_OPTION_NAME . '[smu_Instagram]',
		array(
			'type'              => 'option',
			'default'           => '',
			'sanitize_callback' => 'basic_sanitize_text',
	...
	$wp_customize->add_control( 'smu_Instagram_control',
		array(
			'settings' => BASIC_OPTION_NAME . '[smu_Instagram]',
			'label'    => 'Instagram URL',
			'section'  => 'social_media_url',
			'type'     => 'text',
		)
...
add_action( 'customize_register', 'customozer_social_media_url' );
